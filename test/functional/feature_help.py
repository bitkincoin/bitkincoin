...
"""Verify that starting bitkincoin with -h works as expected."""

from test_framework.test_framework import BitkincoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BitkincoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitkincoin with -h for help text")
        ...
        self.log.info("Start bitkincoin with -version for version information")
        ...
        self.log.info("Start bitkincoind with -fakearg to make sure it does not start")
