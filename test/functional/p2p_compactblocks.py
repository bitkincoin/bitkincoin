...
# TestP2PConn: A peer we use to send messages to bitkincoind, and store responses.
...
class CompactBlocksTest(BitkincoinTestFramework):
    ...
    # This test actually causes bitkincoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitkincoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitkincoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitkincoind will not send blocktxn responses for blocks whose height is
