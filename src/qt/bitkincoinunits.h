...
/** Bitkincoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitkincoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitkincoinUnits(QObject *parent);

    /** Bitkincoin units.
      @note Source: https://en.bitkincoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTK,
...
typedef BitkincoinUnits::Unit BitkincoinUnit;
