This directory contains the BitkincoinQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Used to process BIP21 and BIP70 (see https://github.com/bitkincoin/bitkincoin/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a bitkincoin:... link from a browser).
