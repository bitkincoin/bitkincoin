/* src/config/bitkincoin-config.h.  Generated from bitkincoin-config.h.in by configure.  */
/* src/config/bitkincoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitkincoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitkincoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bitkincoin/bitkincoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bitkincoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitkincoin Core 0.17.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitkincoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitkincoincore.org/"
