...
{
    BOOST_CHECK(TestSplitHost("www.bitkincoincore.org", "www.bitkincoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitkincoincore.org]", "www.bitkincoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitkincoincore.org:80", "www.bitkincoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitkincoincore.org]:80", "www.bitkincoincore.org", 80));
