...
* bitkincoin.conf: contains configuration settings for bitkincoind or bitkincoin-qt
* bitkincoind.pid: stores the process id of bitkincoind while running
...
* debug.log: contains debug information and general logging generated by bitkincoind or bitkincoin-qt
